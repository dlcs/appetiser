...
from app.jp2.image import is_tile_optimised_jp2, _correct_img_orientation
...
def test_correct_img_orientation_jpeg_none():
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/0.jpeg"
    )
...
def test_correct_img_orientation_jpeg_1():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/1.jpeg"
    )
...
def test_correct_img_orientation_jpeg_2():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/2.jpeg"
    )
    base_img = Image.open(base_img_path)
    img = Image.open(img_path)
    corrected_img = _correct_img_orientation(img)
...
def test_correct_img_orientation_jpeg_3():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/3.jpeg"
    )
    base_img = Image.open(base_img_path)
    img = Image.open(img_path)
    corrected_img = _correct_img_orientation(img)
...
def test_correct_img_orientation_jpeg_4():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/4.jpeg"
    )
    base_img = Image.open(base_img_path)
    img = Image.open(img_path)
    corrected_img = _correct_img_orientation(img)
...
def test_correct_img_orientation_jpeg_5():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/5.jpeg"
    )
    base_img = Image.open(base_img_path)
    img = Image.open(img_path)
    corrected_img = _correct_img_orientation(img)
...
def test_correct_img_orientation_jpeg_6():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/6.jpeg"
    )
    base_img = Image.open(base_img_path)
    img = Image.open(img_path)
    corrected_img = _correct_img_orientation(img)
...
def test_correct_img_orientation_jpeg_7():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/7.jpeg"
    )
    base_img = Image.open(base_img_path)
    img = Image.open(img_path)
    corrected_img = _correct_img_orientation(img)
...
def test_correct_img_orientation_jpeg_8():
    ...
    img_path = (
        pathlib.Path(__file__).parent / "fixtures/_correct_img_orientation/8.jpeg"
    )
    base_img = Image.open(base_img_path)
    img = Image.open(img_path)
    corrected_img = _correct_img_orientation(img)
